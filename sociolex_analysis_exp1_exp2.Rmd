...
```{r}
sociolex_demographics_words <- read_csv("sociolex_data/processed/sociolex_demographics_words.csv") # participant demographics

sociolex_ratings_long_words <- read_csv("sociolex_data/processed/sociolex_ratings_words.csv") # raw word ratings along the dimensions of gender, location, political alignment and valence

sociolex_ratings_long_words_age <- read_csv("sociolex_data/processed/sociolex_ratings_words_age.csv") # raw word ratings along the dimension of age

sociolex_demographics_images <- read_csv("sociolex_data/processed/sociolex_demographics_images.csv") # raw picture ratings along the dimensions of gender, location, political alignment and valence

sociolex_ratings_long_images <- read_csv("sociolex_data/processed/sociolex_ratings_images.csv") # raw picture ratings along the dimensions of gender, location, political alignment and valence
